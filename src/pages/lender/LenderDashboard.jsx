          ...
          {safeLoans.length > 0 ? safeLoans.map(loan => (
            <div key={loan.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              ...
              <button 
                ...
                className="w-full py-2.5 bg-[#2E7D32] hover:bg-emerald-600 text-white rounded-xl text-xs font-bold shadow-sm flex items-center justify-center transition-colors"
              >
                Review Application
  ...
  const renderApplicationReview = () => (
    <div className="space-y-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center text-green-800 mb-6 shadow-sm">
        ...
        <div>
          <h3 className="font-bold text-green-800">Platform Verification Passed (Risk Score: 88/100)</h3>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start text-amber-800 mb-8 shadow-sm">
        <AlertCircle className="w-5 h-5 mr-3 text-amber-600 mt-0.5 flex-shrink-0" />
        <div>
          <h3 className="font-bold text-amber-800 mb-1">Escrow Recourse Protection Active</h3>
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-4 border-t pt-6 border-slate-200">
        ...
        <button 
          ...
          className="px-6 py-2.5 rounded-xl bg-[#2E7D32] text-white hover:bg-green-700 font-medium transition-colors shadow-sm flex items-center"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-slate-50 p-6 rounded-xl border border-slate-100">
          ...
          <div className="bg-white p-5 rounded-xl border border-orange-200 shadow-sm">
            ...
            <div className="bg-orange-50 px-3 py-2 rounded-lg border border-orange-100">
              <p className="text-xs text-orange-700 font-medium">Automatic deduction scheduled from upcoming Escrow settlement.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 self-start">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
            <p className="text-xs font-bold text-amber-800 mb-1">Direct Escrow Recourse Setup</p>
            <p className="text-sm text-amber-700">15% of in-bound trade proceeds automatically routed to loan account upon settlement.</p>
          </div>
        </div>
      </div>
