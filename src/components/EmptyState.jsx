  ...
  return (
    <div className="bg-white rounded-2xl p-6 my-4 text-center flex flex-col items-center justify-center border border-slate-200 space-y-3">
      <div className="w-14 h-14 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500">
        <IconComponent className="w-7 h-7 text-[#1B5E20]/80" />
      </div>
      ...
      {onClearFilters && (
        <button
          ...
          className="btn-touch mt-2 px-4 py-2 rounded-xl bg-slate-50 text-slate-700 hover:bg-slate-700 text-[#1B5E20] border border-slate-200 text-xs font-semibold flex items-center space-x-1.5"
        >
