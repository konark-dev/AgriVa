    ...
    <>
      <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-slate-200 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-2.5">
          <div className="w-9 h-9 rounded-xl bg-[#1B5E20] flex items-center justify-center text-white shadow-sm">
            <Tractor className="w-5 h-5" />
          </div>
          <div>
            <h1 className="text-base font-bold text-slate-800 tracking-tight leading-tight flex items-center gap-1.5">
              AgriVa
              <span className="text-[10px] uppercase font-semibold px-1.5 py-0.5 rounded bg-green-100 text-[#1B5E20] border border-green-200">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Voice Listen Button */}
          <button className="px-3 py-1.5 rounded-full border border-[#F57F17] text-[#F57F17] bg-orange-50 font-medium text-xs flex items-center space-x-1">
